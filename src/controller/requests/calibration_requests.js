...
export default class CalibrationRequests {
    ...
    static async recordCalibration(token, instrumentId, date, userId, comment, file = undefined, loadBankData = undefined,
                                   ...
                                   klufeData=undefined, calibratedWithPKs=undefined, customFormData=undefined) {

        let header = RequestUtils.buildTokenHeader(token)
        let data = this.buildCreateCalibrationData(instrumentId, date, userId, comment, file, loadBankData, klufeData, calibratedWithPKs, customFormData)
    ...
    static buildCreateCalibrationData(instrumentId, date, userId, comment, file, loadBankData, klufeData, calibratedWithPks, customFormData) {
        ...
        if (loadBankData) {
            ...
            data.append(ModelFields.CalibrationFields.CustomForm, JSON.stringify(customFormData))
        }
        return data
    }
