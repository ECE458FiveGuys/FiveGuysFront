...
class CreateUser extends Component {
    ...
    manageGroupsInput = () =>{
        ...
        if (newArrayBackEndReadable.includes(SHORTEN_LABELS.MODEL_MANAGEMENT) && !newArrayBackEndReadable.includes(SHORTEN_LABELS.INSTRUMENT_MANAGEMENT)){ //if model, remove intrument
            newArrayBackEndReadable.push(SHORTEN_LABELS.INSTRUMENT_MANAGEMENT)
        }
        newState["dropdown"] = newArrayBackEndReadable
        this.setState(newState)
